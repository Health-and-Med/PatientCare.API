...
using PatientCare.Infrastructure.Repositories;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "PatientCare.API", Version = "v1" });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "PatientCare.API V1");
